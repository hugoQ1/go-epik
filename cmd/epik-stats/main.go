...
func main() {
	...
	app := &cli.App{
		...
		Flags: []cli.Flag{
			...
			&cli.StringFlag{
				Name:    "log-level",
				EnvVars: []string{"EPIK_STATS_LOG_LEVEL"},
				Value:   "info",
			},
		},
