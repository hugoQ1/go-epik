...
func doExtract(opts extractOpts) error {
	...
	if rec != nil {
		...
		log.Println(color.YellowString("skipping receipts comparison; we got back a nil receipt from epik"))
	}
	...
	vector := schema.TestVector{
		...
		Meta: &schema.Metadata{
			...
			Gen: []schema.GenerationData{
				...
				{Source: "github.com/EpiK-Protocol/go-epik", Version: version.String()}},
		},
...
func fetchThisAndPrevTipset(ctx context.Context, api api.FullNode, target types.TipSetKey) (targetTs *types.TipSet, prevTs *types.TipSet, err error) {
	...
	// https://github.com/EpiK-Protocol/go-epik/issues/2847
