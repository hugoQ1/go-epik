...
func printMessage(cctx *cli.Context, msg *types.Message) error {
	...
	fmt.Println("Value:", types.EPK(msg.Value))
	fmt.Println("Max Fees:", types.EPK(msg.RequiredFunds()))
	fmt.Println("Max Total Cost:", types.EPK(big.Add(msg.RequiredFunds(), msg.Value)))
