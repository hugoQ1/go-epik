...
var jwtCmd = &cli.Command{
	Name:  "jwt",
	Usage: "work with epik jwt secrets and tokens",
...
var jwtNewCmd = &cli.Command{
	Name:      "new",
	Usage:     "create a new jwt secret and token for epik",
	ArgsUsage: "<name>",
	Description: `Jwt tokens are used to authenticate api requests to the epik daemon.
