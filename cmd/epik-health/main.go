...
var log = logging.Logger("epik-health")
...
func main() {
	...
	app := &cli.App{
		Name:     "epik-health",
		Usage:    "Tools for monitoring epik daemon health",
...
var watchHeadCmd = &cli.Command{
	...
	Action: func(c *cli.Context) error {
		...
		// Restarting epik systemd unit kills api connection
		os.Exit(130)
		return nil
	},
}
...
/*
 * A thin wrapper around epik cli GetFullNodeAPI
 * Adds retry logic
 */
