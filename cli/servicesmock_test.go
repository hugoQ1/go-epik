...
// Source: github.com/EpiK-Protocol/go-epik/cli (interfaces: ServicesAPI)
...
func (m *MockServicesAPI) DecodeTypedParamsFromJSON(arg0 context.Context, arg1 address.Address, arg2 abi.MethodNum, arg3 string) ([]byte, error) {
	m.ctrl.T.Helper()
...
func (m *MockServicesAPI) Send(arg0 context.Context, arg1 SendParams) (cid.Cid, error) {
	m.ctrl.T.Helper()
